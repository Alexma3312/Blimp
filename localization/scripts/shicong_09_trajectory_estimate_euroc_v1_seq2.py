...
from localization.configs.myconfig_euroc_v1_seq2 import *
from mapping.bundle_adjustment.mapping_result_helper import load_poses_from_file


def run():
    """Execution."""
    directory_name = "/home/sma96/datasets/EuRoC/localization/V1_02_medium/"
    ...
    image_directory_path = directory_name+'source_images_20fps/'
