...
class MappingBackEnd():
    ...
    def create_initial_estimate(self):
        ...
        for landmark_idx, observation_list in enumerate(self._landmark_map):
            ...
            # count_single = 0
            # for observation_idx, observation in enumerate(observation_list):
            #     key_point = observation[1]
            #     pose_idx = observation[0]
            #     pose = self._pose_estimates[pose_idx]
            ...
            #     if result is False:
            #         del self._landmark_map[landmark_idx][observation_idx]
            #         count += 1
            #         count_single += 1
            # if count_single == len(observation_list) or len(observation_list) < self._seen:
            #     print('special case')
            #     # del self._landmark_map[landmark_idx]
                
            # if count_single != 0:
            #     print("count_single", count_single)
