...
"""
# pylint: disable=invalid-name, no-name-in-module, no-member, wrong-import-order,assignment-from-no-return
...
class TestMappingBackEnd(GtsamTestCase):
    ...
    def test_load_image_matches(self):
        ...
        self.assertEqual(len(image_matches), self.num_images)
